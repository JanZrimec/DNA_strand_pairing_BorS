function [dG,dH,dS,bp,loop,dangle,data] = pairing_main_par(seq1,seq2,NN_dG,NN_dH,NN_dS,gap)
...
[score,path,F,pointer] = pairing_scoring_traceback(intseq1,m,intseq2,n,NN_dG,gap);
    
% pairing of reversed sequences
[score2,path2,F2,pointer2] = pairing_scoring_traceback(intseq1(end:-1:1),m,intseq2,n,NN_dG,gap);
